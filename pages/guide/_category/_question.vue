<template>
    ...
    <article class="article-page">
      ...
      <section class="article-factors" v-if="factors.length > 0">
        <h2>Factors</h2>
        <p>You can also adjust your score on this page after learning more about each option below. Your score will update immediately.</p>

        <section class="article-radio-inputs">
          <review-radio-input
            v-for="f of factors"
            :name=inputName
            :key=f.slug
